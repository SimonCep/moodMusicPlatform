...
# Add rest_framework.authentication.SessionAuthentication if needed for browsable API
REST_FRAMEWORK = {
...
# For production, configure a real email service (e.g., SMTP, SendGrid, Mailgun)
